...
<Icon name="home" />                       {/* 18px, 1.5px stroke, currentColor */}
...
`@hugeicons/core-free-icons` (stroke, rounded, 1.5px).
...
Size `18`, `strokeWidth` `1.5`, color inherited (`currentColor`). Override per
