// Siri Orb — adapted from smoothui (npx smoothui add siri-orb) to this repo's
// JSX/Tailwind v3 setup: TS types dropped, `cn` inlined, behaviour unchanged.
// A rotating multi-stop conic-gradient blob with a gooey blur/contrast pass;
// self-contained styles via an inline <style> (uses @property --angle). Ships
// its own reduced-motion guard (freezes the rotation).
